...
// Exploded-view heights per part (Y, glTF up), scaled by `explode` 0..1. lens/cradle/leds share
// one lift (they live under IpCamera's rotated head-pivot group and move together as it rises —
// P2-R8; distinct per-part lifts there would tilt with pan/tilt instead of rising straight up).
const LIFT: Record<string, number> = { base: 0, screws: 0.25, body: 0.45, board: 0.7, ring: 0.95, cradle: 1.35, leds: 1.35, lens: 1.35, status_led: 0.45, dome: 2.0 };
